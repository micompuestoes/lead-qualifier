...
const SECCIONES: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      'Inmuebia es una plataforma SaaS que utiliza inteligencia artificial para cualificar leads inmobiliarios, generar respuestas y ayudar a las agencias a priorizar sus contactos comerciales.',
...
export default function TerminosPage() {
  return (
    <LegalDoc
      ...
      intro="Estos términos regulan el uso de Inmuebia. Te recomendamos leerlos con atención antes de utilizar la plataforma."
      sections={SECCIONES}
    />
  );
}

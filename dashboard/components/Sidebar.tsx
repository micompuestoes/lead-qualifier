...
// Links visibles según plan
function buildLinks(perfil: Perfil) {
  const base = [...navLinks];
  if (perfil.plan === 'agencia') base.push(...agenciaLinks);
  if (perfil.is_admin) base.push(adminLink);
  return base;
}
